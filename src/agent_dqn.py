...
INITIAL_EPSILON = 1.0
FINAL_EPSILON = 0.1
INITIAL_REPLAY_SIZE = 5000#50000
EXPLORATION_STEPS = 1000#1e6
NUM_REPLAY_MEMORY = 10000#100000
TRAIN_INTERVAL = 2#4
TARGET_UPDATE_INTERVAL = 50#5000
...
class Agent_DQN(Agent):
    def __init__(self, env, args):
        ...
        optimizer = tf.train.RMSPropOptimizer(self.args.lr, momentum=0, epsilon=1, decay=0.99)
        # gradient clipping
    ...
    def train_net(self, state, action, reward, terminal, next_state):
        ...
        if self.t >= INITIAL_REPLAY_SIZE:
            ...
            if terminal:
                ...
                # save network
                if self.episode > 50 and self.episode % 5 == 0:  #if self.episode > 5000 and self.episode % 500 == 0
